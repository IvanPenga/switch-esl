...
class ChannelHangup extends AbstractEvent {
  ...
  public variable_transfer_history= '';
  public variable_transfer_source= '';
  ...
  public variable_conference_call_key= '';
